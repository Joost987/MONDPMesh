...
if simulate_two_bodies: 
    ...
    EFE_M = [EFE_on,EFE_M_strength]; T = 1000; iterlength = 4; regime = 1 
    ...
    posmat_cuda,vecmat_cuda,AngMat_cuda,MomMat_cuda,EkinMat_cuda,EgravMat_cuda,EMat_cuda,COM_cuda = particlelist.TimeSim(T,dt,iterlength,EFE_M,free_fall,regime)
    ...
    plt.plot(EgravMat,label="E grav")
